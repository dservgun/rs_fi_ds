pub mod rates {
    ...
    impl PartialEq for NextSettlementDate {
        fn eq(&self, other: &Self) -> bool {
            return self.start_date == other.start_date && (f32::EPSILON < (self.term - other.term).abs());
        }
    }
    ...
    impl NextSettlementDate {
        ...
        pub fn get_settlement_dates(&self, calendar : Vec<NextSettlementDate>) -> HashMap<NextSettlementDate, Vec<NextSettlementDate>> {
